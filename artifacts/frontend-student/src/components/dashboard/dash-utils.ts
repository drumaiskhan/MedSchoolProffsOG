...
export const dayPartForHour = (hour: number): DayPart => (hour < 12 ? 'morning' : hour < 17 ? 'afternoon' : 'evening');
export const DAY_PART_GLYPH: Record<DayPart, string> = { morning: '🌅', afternoon: '☀️', evening: '🌙' };
export const DAY_PART_LABEL: Record<DayPart, string> = { morning: 'Good morning', afternoon: 'Good afternoon', evening: 'Good evening' };
