...
function Dashboard() {
  ...
  return <>{q.isLoading ? <SkeletonPage /> : <div className="space-y-9">
    ...
    <section id="progress-profile" className="scroll-mt-24 rounded-2xl transition-shadow duration-700"><SectionHeader eyebrow="Where you stand" title="Progress profile" action={<Link href="/progress" className="inline-flex items-center gap-1 text-xs font-extrabold text-primary" data-testid="link-full-progress">Full progress <ArrowRight size={13} /></Link>} /><ProgressProfileCard /></section>
